...
api: "POST https://api.poyo.ai/v1/chat/completions"
...
<RequestExample>
  ...
  const url = "https://api.poyo.ai/v1/chat/completions";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://api.poyo.ai/v1/chat/completions";
  ...
  let url = URL(string: "https://api.poyo.ai/v1/chat/completions")!
  ...
  class Program
  {
      ...
      {
          var url = "https://api.poyo.ai/v1/chat/completions";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://api.poyo.ai/v1/chat/completions";
          // Can be replaced with any supported model ID
          const char *payload = "{"
              "\"model\":\"gpt-4o\","
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://api.poyo.ai/v1/chat/completions"];
  ...
  let url = "https://api.poyo.ai/v1/chat/completions"
  ...
  void main() async {
    final url = Uri.parse('https://api.poyo.ai/v1/chat/completions');
