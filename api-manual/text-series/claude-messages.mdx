...
<RequestExample>
  ...
  const url = "https://api.poyo.ai/v1/messages";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://api.poyo.ai/v1/messages";
  ...
  let url = URL(string: "https://api.poyo.ai/v1/messages")!
  ...
  class Program
  {
      ...
      {
          var url = "https://api.poyo.ai/v1/messages";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://api.poyo.ai/v1/messages";
          const char *payload = "{"
              "\"model\":\"claude-sonnet-4-5-20250929\","
              "\"max_tokens\":1024,"
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://api.poyo.ai/v1/messages"];
  ...
  let url = "https://api.poyo.ai/v1/messages"
  ...
  void main() async {
    final url = Uri.parse('https://api.poyo.ai/v1/messages');
