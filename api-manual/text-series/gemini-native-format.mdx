...
<RequestExample>
  ...
  curl --request POST \
    --url https://api.poyo.ai/v1beta/models/gemini-2.5-pro:generateContent \
  ...
  const url = "https://api.poyo.ai/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://api.poyo.ai/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  url = URI("https://api.poyo.ai/v1beta/models/gemini-2.5-pro:generateContent")
