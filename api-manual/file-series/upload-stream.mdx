...
```bash
curl -X POST "https://dev-api.poyo.ai/api/common/upload/stream" \
...
url = "https://dev-api.poyo.ai/api/common/upload/stream"
...
axios.post('https://dev-api.poyo.ai/api/common/upload/stream', form, {
  headers: {
