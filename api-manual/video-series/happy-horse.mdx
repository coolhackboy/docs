...
The source video must be 3-60 seconds. Video-edit billing uses the probed source video duration, capped at 15 seconds, because output follows the source video and truncates longer input to the first 15 seconds.

## Required Parameters

- **model**: `happy-horse`
- **input.prompt**: Required for text-to-video, reference-to-video, and video-edit. Optional for image-to-video. Maximum length is 5,000 non-Chinese characters or 2,500 Chinese characters.
