...
- `hailuo-02` supports `512P` and `768P`.
- Requests with `end_image_url` use first-and-last-frame generation and must use `768P`. `512P` is not supported with `end_image_url`.
