...
- **character_ids**: Optional character ID array. Maximum `2` character IDs. You can reference the character names in your prompt
...
- `character_ids` is optional and can be used with both text-to-video and image-to-video.
