...
- **Audio Upload Requirement**:
  ...
  - The uploaded audio must not exceed **2 minutes** in duration
...
- In Custom Mode ( `custom_mode: true` ):
  ...
  - `prompt` character limits vary by model:
    - **V3_5 & V4**: Maximum 500 characters
    - **V4_5 & V4_5PLUS**: Maximum 3000 characters
...
- Ensure your audio URL is publicly accessible and the file is under 2 minutes
...
- `persona_id` (string): Persona ID to apply to the covered track.
