...
| 鈫?| `audio_url` | string | Direct download URL for the audio file |
| 鈫?| `image_url` | string | Cover image URL |
| 鈫?| `title` | string | Track title |
| 鈫?| `tags` | string | Style tags |
| 鈫?| `duration` | number | Audio duration in seconds |
| 鈫?| `prompt` | string | Generation prompt used |
| `get-timestamped-lyrics` | `timestampe_lyrics` | string | Lyrics with timestamps |
| `generate-lyrics` | `title` | string | Lyrics title |
| 鈫?| `text` | string | Complete lyrics content |
