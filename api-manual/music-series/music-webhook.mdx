...
<Note>
The webhook body uses the same task-level shape as the music detail response body, without the outer `code` and `data` wrapper. The `files` array content varies depending on which model created the task. See [Response Fields](#response-fields-files-data) below for details.
</Note>
...
```json
{
  ...
  "files": [
    {
      "separate_vocals": "{\"vocal_url\": \"https://storage.poyo.ai/audio/vocals.mp3\", \"instrumental_url\": \"https://storage.poyo.ai/audio/instrumental.mp3\"}"
    }
  ],
  "created_time": "2025-11-25T08:50:13",
  "error_message": null
...
```json
{
  ...
  "files": [
    {
      "vocal_removal": "{\"bass\": \"https://storage.poyo.ai/audio/bass.mp3\", \"drums\": \"https://storage.poyo.ai/audio/drums.mp3\", \"piano\": \"https://storage.poyo.ai/audio/piano.mp3\", \"guitar\": \"https://storage.poyo.ai/audio/guitar.mp3\", \"vocals\": \"https://storage.poyo.ai/audio/vocals.mp3\", \"other\": \"https://storage.poyo.ai/audio/other.mp3\"}"
    }
  ],
  "created_time": "2025-11-25T08:50:13",
  "error_message": null
...
```json
{
  ...
  "files": [
    {
      "generate_cover": "[{\"file_url\": \"https://storage.poyo.ai/audio/cover_1.png\", \"file_type\": \"image\"}, {\"file_url\": \"https://storage.poyo.ai/audio/cover_2.png\", \"file_type\": \"image\"}]"
    }
  ],
  "created_time": "2025-11-25T08:50:13",
  "error_message": null
