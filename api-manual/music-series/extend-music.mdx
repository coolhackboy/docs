...
- `persona_id` (string): Persona ID to apply to the extended music. Only available when `default_param_flag: true` with V5/V5_5. How to generate persona_id, visit [generate-persona](/api-manual/music-series/generate-persona).
