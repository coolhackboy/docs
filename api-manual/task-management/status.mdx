...
```http
GET https://dev-api.poyo.ai/api/generate/status/{task_id}
```
...
```bash
curl -X GET https://dev-api.poyo.ai/api/generate/status/task-unified-1757165031-uyujaw3d \
...
response = requests.get(
    f"https://dev-api.poyo.ai/api/generate/status/{task_id}",
...
const response = await fetch(
  `https://dev-api.poyo.ai/api/generate/status/${taskId}`,
  {
    headers: {
...
public class PoYoAPI {
    ...
    private static final String BASE_URL = "https://dev-api.poyo.ai";
...
api_key = 'your-api-key-here'
task_id = 'task-unified-1757165031-uyujaw3d'
base_url = 'https://dev-api.poyo.ai'
