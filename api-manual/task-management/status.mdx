...
Query the execution status of image, video, and 3D generation tasks and retrieve results when complete.
...
| `data.files[].file_type` | string | Type of generated file: `image`, `video`, `3d`, or `other` |
