...
- **input.image_url** or **input.image_urls**: Required for image models. Use `image_url` or exactly one item in `image_urls` for image-to-3D; use 2-4 items in `image_urls` for multiview-to-3D
