...
- **nano-banana-2-official** - Text-to-image generation with `output_format`, `size=auto`, and `0.5K` / `1K` / `2K` / `4K` resolution
- **nano-banana-2-official-edit** - Image editing with up to 14 reference images, plus `output_format`, `size=auto`, and `0.5K` / `1K` / `2K` / `4K` resolution
