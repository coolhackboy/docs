...
| `input.prompt` | string | Description of the desired image or editing instructions (max 1000 characters) |
...
| `input.size` | string | `auto` | Aspect ratio: `auto`, `1:1`, `2:3`, `3:2`, `4:3`, `3:4`, `16:9`, `9:16` |
...
|---------|-------------|--------------|
| Speed | ⚡ Fast (15-45s) | Standard (30-60s) |
| Quality | High | Very High |
| Cost | 💰 Lower (~1.6 credits) | Higher (~2.5 credits) |
