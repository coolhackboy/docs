...
When a task completes, PoYo AI will send a POST request to your callback URL with the same structure as the [status endpoint response](/api-manual/task-management/status):
